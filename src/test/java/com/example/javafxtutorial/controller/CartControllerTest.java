...
//    }
    ...
    @Test
    void testCartItemConstructor_NullBook() {
        // Act & Assert: Verify exception is thrown for null book in constructor
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new CartItem(null, 1, 10.0); // Null book
        });

        assertEquals("Book cannot be null", exception.getMessage()); // Replace with actual message if different
    }
//    @Test
