...
public class AddEmployeePageViewTest2 {
    ...
    public void testSaveButton_AllFieldsEmpty() { // Covers all fields empty
        ...
        Platform.runLater(() -> {
            ...
            // Simulate alert mock logic here
    ...
    @Test
    public void testDuplicateUsername() { // Covers duplicate username validation
        ArrayList<Employee> employees = new ArrayList<>();
    ...
    @Test
    public void testAddValidEmployee() { // Covers adding a valid employee
        ArrayList<Employee> employees = new ArrayList<>();
        ComboBox<String> roleComboBox = new ComboBox<>();
